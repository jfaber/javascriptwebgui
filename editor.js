/*
					...
					ToDo:
							...
							Completed:
									Major: XContext Menu, XFull Cross Compatablity, XCtrl-Drag, XJavacript Maker, 
									Minor: XObject Code Editor, XPage Code Editor, XPlugin Manager
*/
...
createDetailedWindow(200, 200, 699, 148, "Text Editor", "#000000", "#4444FF", true, true, false, true, "#3333FF", "#000000", "#C0C0C0", "#000000", getRichEdit(), "JFEdit.editorWindow",0);
...
//----------------------Edit (2)----------------------
addSub(2, "Page Properties", "openPageProps();", true);
...
//-----------For Absolute-----------------
if(!document.getElementById("JFEdit.propIsPercent").checked)
{
...
{
if(document.getElementById("JFEdit.propTop").value!="")
	document.getElementById(selectedObject).style.top=document.getElementById("JFEdit.propTop").value+"%";
if(document.getElementById("JFEdit.propLeft").value!="")
	document.getElementById(selectedObject).style.left=document.getElementById("JFEdit.propLeft").value+"%";
if(document.getElementById("JFEdit.propWidth").value!="")
	document.getElementById(selectedObject).style.width=document.getElementById("JFEdit.propWidth").value+"%";
if(document.getElementById("JFEdit.propHeight").value!="")
	document.getElementById(selectedObject).style.height=document.getElementById("JFEdit.propHeight").value+"%";
}
...
document.getElementById("JFEdit.propSelectedObject").value=selectedObject;
document.getElementById("JFEdit.propTop").value=document.getElementById(selectedObject).style.top.replace("px","").replace("%","");
document.getElementById("JFEdit.propLeft").value=document.getElementById(selectedObject).style.left.replace("px","").replace("%","");
document.getElementById("JFEdit.propWidth").value=document.getElementById(selectedObject).style.width.replace("px","").replace("%","");
document.getElementById("JFEdit.propHeight").value=document.getElementById(selectedObject).style.height.replace("px","").replace("%","");
document.getElementById("JFEdit.propBorder").value=document.getElementById(selectedObject).style.border.replace("px solid black","");
...
//------------------------------Open Page Props----------------------------------
function openPageProps()
{
	createDetailedWindow(500, 90, 450, 210, "Page Properties", '#000000', '#4444FF', true, true, true, true, '#3333FF', '#000000', '#FFFFFF', '#000000', getPageProps() , 'JFEdit.pageProps',0);
	setTimeout('updatePageProps();',500);
	document.getElementById("JFEdit.pageProps").style.height=(document.getElementById("JFEdit.PPTable").offsetHeight+10)+"px";
...
{
document.getElementById("JFEdit.PPtitle").value=document.title;
document.getElementById("JFEdit.PPbgColor").value=document.body.style.backgroundColor;
document.getElementById("JFEdit.PPbgImage").value=document.body.style.backgroundImage.replace("url(\"","").replace("\")","");
document.getElementById("JFEdit.PPnoRepeat").checked=true;
document.getElementById("JFEdit.PPallRepeat").checked=document.body.style.backgroundRepeat=="repeat";
document.getElementById("JFEdit.PPxRepeat").checked=document.body.style.backgroundRepeat=="repeat-x";
document.getElementById("JFEdit.PPyRepeat").checked=document.body.style.backgroundRepeat=="repeat-y";
document.getElementById("JFEdit.PPfixed").checked=document.body.style.backgroundAttachment=="fixed";

}

//----------------------------Change Page Props-----------------------------------
function changePageProps()
{
document.title=document.getElementById("JFEdit.PPtitle").value;
document.body.style.backgroundColor=document.getElementById("JFEdit.PPbgColor").value;
document.body.style.backgroundImage= "url('" + document.getElementById("JFEdit.PPbgImage").value+"')";
if(document.getElementById("JFEdit.PPnoRepeat").checked)
	document.body.style.backgroundRepeat="no-repeat";
if(document.getElementById("JFEdit.PPallRepeat").checked)
	document.body.style.backgroundRepeat="repeat";
if(document.getElementById("JFEdit.PPxRepeat").checked)
	document.body.style.backgroundRepeat="repeat-x";
if(document.getElementById("JFEdit.PPyRepeat").checked)
	document.body.style.backgroundRepeat="repeat-y";
if(document.getElementById("JFEdit.PPfixed").checked)
...
saveString+='</script></head><body style=" '+ getStyle(document.body.style) + ' " >';
saveString+=document.body.innerHTML;
saveString+="\n</body></html>"
saveString=saveString.replace(/contenteditable=\"true\"/g,"");
saveString=saveString.replace(/contenteditable=\"false\"/g,"");
...
//-------------Strip All Actions before adding-----------------
//strips all actions: Onclick, onmouseover, onmouseout
//Need to convert to an array with the things to remove.

//
while(saveString.indexOf('onclick="',currentIndex)!=-1)
{
currentIndex=saveString.indexOf('onclick="',currentIndex)*1;
scriptArray[0]=saveString.substring(0,currentIndex);
scriptArray[2]=saveString.substring(saveString.indexOf('"',currentIndex+9)+1);
saveString=scriptArray[0]+scriptArray[2];
}
currentIndex=0;
while(saveString.indexOf('onmouseover="',currentIndex)!=-1)
{
currentIndex=saveString.indexOf('onmouseover="',currentIndex)*1;
scriptArray[0]=saveString.substring(0,currentIndex);
scriptArray[2]=saveString.substring(saveString.indexOf('"',currentIndex+13)+1);
saveString=scriptArray[0]+scriptArray[2];
}
currentIndex=0;
while(saveString.indexOf('onmouseout="',currentIndex)!=-1)
{
currentIndex=saveString.indexOf('onmouseout="',currentIndex)*1;
scriptArray[0]=saveString.substring(0,currentIndex);
scriptArray[2]=saveString.substring(saveString.indexOf('"',currentIndex+12)+1);
saveString=scriptArray[0]+scriptArray[2];
}
while(saveString.indexOf('style="',currentIndex)<-1)
{
currentIndex=saveString.indexOf('style="',currentIndex)*1;
scriptArray[0]=saveString.substring(0,currentIndex);
scriptArray[2]=saveString.substring(saveString.indexOf('"',currentIndex+12)+1);
saveString=scriptArray[0]+scriptArray[2];
}
...
saveString=saveString.replace(/</g,"\n<");
saveString=saveString.replace(/<br \/>/g,"<br />\n");
saveString=saveString.replace(/<br>/g,"<br />\n");
...
if(document.getElementById(saveString.substring(currentIndex,currentIndex+12)))
	{
		if(document.getElementById(saveString.substring(currentIndex,currentIndex+12)).onclick)
			...
			scriptArray[1]=' onclick="' + tmpS.replace(/\"/g,"'")+inlineJSAdd + '"';
			scriptArray[2]=saveString.substring(currentIndex+14)
			saveString=scriptArray[0]+scriptArray[1].replace(/\n/g,"").replace(/function/g,"").replace(/}/g,"").replace(/{/g,"").replace(/\(\)/g,"")+scriptArray[2];
			}
		if(document.getElementById(saveString.substring(currentIndex,currentIndex+12)).onmouseover)
			...
			scriptArray[1]=' onmouseover="' + tmpS.replace(/\"/g,"'")+inlineJSAdd + '"';
			scriptArray[2]=saveString.substring(currentIndex+14)
			saveString=scriptArray[0]+scriptArray[1].replace(/\n/g,"").replace(/function/g,"").replace(/}/g,"").replace(/{/g,"").replace(/\(\)/g,"")+scriptArray[2];
			}
		if(document.getElementById(saveString.substring(currentIndex,currentIndex+12)).onmouseout)
			...
			scriptArray[1]=' onmouseout="' + tmpS.replace(/\"/g,"'") +inlineJSAdd+ '"';
			scriptArray[2]=saveString.substring(currentIndex+14)
			saveString=scriptArray[0]+scriptArray[1].replace(/\n/g,"").replace(/function/g,"").replace(/}/g,"").replace(/{/g,"").replace(/\(\)/g,"").replace(/\;/g,"")+scriptArray[2];
			}
		if(document.getElementById(saveString.substring(currentIndex,currentIndex+12)).style)
			{
			scriptArray[0]=saveString.substring(0,currentIndex+13);
			tmpS=(getStyle(document.getElementById(saveString.substring(currentIndex,currentIndex+12)).style)).toString();
			scriptArray[1]=' style="' + tmpS.replace(/\"/g,"'") +inlineJSAdd+ '"';
			scriptArray[2]=saveString.substring(currentIndex+14)
			saveString=scriptArray[0]+scriptArray[1]+scriptArray[2];
			}			
		}
	}
//createSimpleWindow('Copy This','<input type=text value="'+saveString+'"/>','theHTMLWin');
saveString=saveString.replace(/onclick\(event\)/g,"").replace(/onmouseover\(event\)/g,"").replace(/onmouseout\(event\)/g,"");
